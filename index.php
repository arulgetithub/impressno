...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <!--<h1><a href="index.html">Lumia</a></h1>-->
         <a href="index.php"><img src="assets/img/Impress_logo.png" alt="" class="img-fluid"></a>
      </div>
      <!-- ======= End of Logo ====== -->
      <!-- ======= Menu Bar ====== -->
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Sign In/Up</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#SignupForm">
                    Sign Up</a></li>
              <li>
                <a href="" class="btn btn-default btn-rounded mb-4" data-toggle="modal" data-target="#LoginForm">
                    Sign In</a>
            </li>
            </ul>
          </li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to <span>Impressno Solutions</span></h1>
  ...
  <main id="main">
    ...
    <section id="announcements" class="testimonials section-bg" style="padding-top: 5px;">
        <div class="container">
            ...
            <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      ...
                      sint minim.<i class="bx bxs-quote-alt-right quote-icon-right"></i></p>
                              <a href="#about" class="btn-get-started scrollto">Read More</a>
                        </div>
                    </div>
                    <!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                        	<h3>Message 3</h3>
                            <p><i class="bx bxs-quote-alt-left quote-icon-left"></i>Quis quorum aliqua sint quem 
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p><i class="bx bxs-quote-alt-left quote-icon-left"></i>
                              ...
                              xport minim fugiat minim velit minim dolor enim duis veniam ipsum anim magna 
                    ...
                    <div class="swiper-slide">
                      ...
                      minim.<i class="bx bxs-quote-alt-right quote-icon-right"></i></p>
                              <a href="#about" class="btn-get-started scrollto">Read More</a>
                        </div>
                    </div>
                    <!-- End testimonial item -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>We are a collective of experienced Information Technology professionals with a wide range of technical expertise, who share in the ideal vision and standards of unparalled customer service.  Our practices are geared toward the modernization of current systems for established companies, as well as the creation of completely new systems for startups.  Our goal is to bridge the gap between each aspect of data and information management and production, allowing our clients to concentrate on their business without concern over the data management aspect.</p>
            
            <div class="row icon-boxes">
              <div class="col-md-6">
                <i class="bx bx-receipt"></i>
                <h4>What We Do</h4>
                <p>Areas of expertise for both PC and Mac products include:</p>
              </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets/img/clients/client-1.jpg" class="testimonial-img" alt="">
                <h3>Toyota</h3>
                <h4>Engine Manufaturing Unit</h4>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <strong><p>CHRIST (Deemed to be Univesity)</p></strong>
            <p>
              Kengeri <br>
              Bangalore<br>
              Karnataka <br><br>
...
<div class="modal fade" id="LoginForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form name="frmLogin" action="login/login.php" method="post">
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          <label data-error="wrong" data-success="right" for="uname">
            <i class="fas fa-envelope prefix grey-text"></i> User Email
          </label>
          <input type="text" id="uname" name="uname" class="form-control validate">
        </div>

        <div class="md-form mb-4">
        <label data-error="wrong" data-success="right" for="upass">
          <i class="fas fa-lock prefix grey-text"></i> Password
        </label>
          <input type="password" id="upass" name="upass" class="form-control validate">
        </div>
      </div>
      <div class="modal-footer d-flex justify-content-center">
        <button type="submit" id="log" name="log" value="login" class="button">Login</button>
      </div>
      </form>
    </div>
  </div>
    ...
    aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form name="frmSignup" action="login/signup.php" method="post">
            <div class="modal-body mx-3">
              <div class="md-form mb-5">
                <label data-error="wrong" data-success="right" for="user-fname">
                <i class="fas fa-user prefix grey-text"></i> User FirstName
                </label>
                <input type="text" id="user-fname" name="user-fname" class="form-control validate">
              </div>
              <div class="md-form mb-4">
                <label data-error="wrong" data-success="right" for="user-email">
                <i class="fas fa-envelope prefix grey-text"></i> User Email ID
                </label>
                <input type="email" id="user-email" name="user-email" class="form-control validate">
              </div>
              <div class="md-form mb-4">
                <label data-error="wrong" data-success="right" for="user-pass">
                <i class="fas fa-lock prefix grey-text"></i> Password
                </label>
                <input type="password" id="user-pass" name="user-pass" class="form-control validate">
              </div>
              <div class="md-form mb-4">
                <label data-error="wrong" data-success="right" for="user-cpass">
                <i class="fas fa-lock prefix grey-text"></i> Confirm Password
                </label>
                <input type="password" id="user-cpass" name="user-cpass" class="form-control validate">
              </div>
            </div>
            <div class="modal-footer d-flex justify-content-center">
              <button type="submit" id="reg" name="reg" value="register" class="">Register</button>
            </div>
          </form>
        </div>
      </div>
